...
function space_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  ...
  $form['space_settings']['main_header_media'] = array(
    '#type' => 'managed_file',
  ...
  $form['space_settings']['media_type'] = array(
    '#type' => 'checkbox',
  ...
  $form['space_settings']['video_settings'] = array(
    '#type' => 'details',
  ...
  $form['space_settings']['video_settings']['header_video_still'] = array(
    '#type' => 'managed_file',
    '#title' => t('Video Still'),
